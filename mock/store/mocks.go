...
// Source: github.com/figment-networks/polkadothub-indexer/store (interfaces: AccountEraSeq,BlockSeq,BlockSummary,Database,EventSeq,Reports,Syncables,SystemEvents,TransactionSeq,ValidatorAgg,ValidatorSeq,ValidatorEraSeq,ValidatorSessionSeq,ValidatorSummary)
