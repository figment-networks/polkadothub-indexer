...
mockgen:
	...
	@mockgen -destination mock/store/mocks.go github.com/figment-networks/polkadothub-indexer/store AccountEraSeq,BlockSeq,BlockSummary,Database,EventSeq,Reports,Syncables,ValidatorAgg,ValidatorEraSeq,ValidatorSessionSeq,ValidatorSummary
